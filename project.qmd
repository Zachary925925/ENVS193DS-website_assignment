...
I visualized the mean and distribution status of Pm 2.5 concentration within those cites.
![](photos/code5.png)

![](photos/code6.png)
Then, I did QQ test to test out the normality of the data in two cites.
![](photos/code7.png)
![](photos/code8.png)
Turned out that they are not normally distributed.

So I did a Welch two sample t test to find out how different two cites are.
